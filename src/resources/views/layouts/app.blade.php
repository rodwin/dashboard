        ...
        <div id="page-wrapper">
            ...
            <div id="page-header" class="clearfix">
                <div id="header-logo" class="rm-transition">
                    ...
                    <span>Supina Admin <i class="opacity-80">1.0</i></span>
                ...
                <div id="sidebar-search">
                    <input type="text" placeholder="Search..." class="autocomplete-input input tooltip-button"
                           data-placement="bottom" title="Type &apos;jav&apos; to see the available tags..." id=""
                           name="">
                ...
                <div id="header-right">
                    <div class="user-profile dropdown">
                        <a href="#" title="" class="user-ico clearfix" data-toggle="dropdown">
                            <img width="36" src="{{ Gravatar::get(Auth::user()->email)}}" alt="">
                    ...
                    <div class="top-icon-bar float-right">
                        ...
                        <div class="dropdown">
                            <a href="#" data-toggle="dropdown" data-placement="left"
                               class="popover-button-header tooltip-button" title="Example menu">
                            ...
                            <div class="dropdown-menu float-right">
                                ...
                                <span class="glyph-icon icon-separator-vertical pad0A medium">
                                    ...
                                    <div class="bg-gray text-transform-upr font-size-12 font-gray-dark pad10A">Dashboard
                                        menu
                                    </div>
                                    <div class="pad5T pad10B pad10L pad10R dashboard-buttons clearfix">
                ...
                <div id="page-sidebar-wrapper">
                    <div id="sidebar-top">
                        <ul class="nav nav-pills nav-justified">
                            <li class="active"><a href="#tab-example-1" data-toggle="tab"><i
                                            class="glyph-icon icon-users"></i></a></li>
                            <li><a href="#tab-example-2" data-toggle="tab"><i class="glyph-icon icon-bell"></i></a></li>
                            <li><a href="#tab-example-3" data-toggle="tab"><span class="small-badge bg-red"></span><i
                        ...
                        <div class="tab-content">
                            <div class="tab-pane clearfix fade active in" id="tab-example-1">
                                ...
                                <div class="user-profile-sm clearfix">
                                    <img width="45" class="img-rounded" src="{{ Gravatar::get(Auth::user()->email)}}"
                                         alt="">
                            ...
                            <div class="tab-pane clearfix fade" id="tab-example-4">
                                <div class="complete-user-profile">
                                    ...
                                    <div class="progressbar-small progressbar" data-value="75">
                                        <div class="progressbar-value bg-azure tooltip-button" title=""
                                             data-original-title="45%"></div>
                                    </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#" title="Presentation websites">
                                    ...
                                    <span class="bs-label label-success">32</span>
                                </a>
                                <ul>
                                    <li class="header"><span>Homepage</span></li>
                                    <li><a href="featured-area-1.html" title="Hero area 1"><span>Hero area 1</span></a>
                                    </li>
                                    <li><a href="featured-area-2.html" title="Hero area 2"><span>Hero area 2</span></a>
                                    </li>
                                    <li><a href="featured-area-3.html" title="Hero area 3"><span>Hero area 3</span></a>
                                    </li>
                                    <li><a href="featured-area-4.html" title="Hero area 4"><span>Hero area 4</span></a>
                                    </li>
                                    <li><a href="featured-area-5.html" title="Hero area 5"><span>Hero area 5</span></a>
                                    </li>
                                    <li><a href="featured-area-6.html" title="Hero area 6"><span>Hero area 6</span></a>
                                    </li>
                                    <li><a href="featured-area-7.html" title="Hero area 7"><span>Hero area 7</span></a>
                                    </li>
                                    <li><a href="featured-area-8.html" title="Hero area 8"><span>Hero area 8</span></a>
                                    </li>
                                    <li><a href="featured-area-9.html" title="Hero area 9"><span>Hero area 9</span></a>
                                    </li>
                                    <li><a href="featured-area-10.html"
                                           title="Hero area 10"><span>Hero area 10</span></a>
                                    </li>
                                    <li><a href="featured-area-11.html"
                                           title="Hero area 11"><span>Hero area 11</span></a>
                                    </li>
                                    <li><a href="featured-area-12.html"
                                           title="Hero area 12"><span>Hero area 12</span></a>
                                    </li>
                                    <li><a href="featured-area-13.html"
                                           title="Hero area 13"><span>Hero area 13</span></a>
                                    </li>
                                    <li><a href="featured-area-14.html"
                                           title="Hero area 14"><span>Hero area 14</span></a>
                                    </li>
                                    <li><a href="featured-area-15.html"
                                           title="Hero area 15"><span>Hero area 15</span></a>
                                    </li>
                                    <li><a href="featured-area-16.html"
                                           title="Hero area 16"><span>Hero area 16</span></a>
                                    </li>
                                    ...
                                    <li><a href="portfolio-2col.html" title="Portfolio 2 columns"><span>2 columns</span></a>
                                    </li>
                                    <li><a href="portfolio-3col.html" title="Portfolio 2 columns"><span>3 columns</span></a>
                                    </li>
                                    <li><a href="portfolio-4col.html" title="Portfolio 4 columns"><span>4 columns</span></a>
                                    </li>
                                    <li><a href="portfolio-6col.html" title="Portfolio 6 columns"><span>6 columns</span></a>
                                    </li>
                                    <li><a href="portfolio-fw1.html"
                                           title="Portfolio full width"><span>Full width</span></a></li>
                                    <li><a href="portfolio-fw2.html" title="Portfolio full width alternate"><span>Full width alternate</span></a>
                                    </li>
                                    <li><a href="portfolio-masonry.html"
                                           title="Portfolio masonry"><span>Full masonry</span></a>
                                    </li>
                                    ...
                                    <li><a href="pricing-table.html" title="Pricing tables"><span>Pricing tables</span></a>
                                    </li>
                                    <li><a href="testimonials.html" title="Testimonials"><span>Testimonials</span></a>
                                    </li>

                                    <li class="header"><span>Footers</span></li>
                                    <li><a href="footer-1.html"
                                           title="Simple black footer"><span>Simple black footer</span></a>
                                    </li>
                                    <li><a href="footer-2.html"
                                           title="Simple blue footer"><span>Simple blue footer</span></a></li>
                                    <li><a href="footer-3.html" title="Grid footer 1"><span>Grid footer 1</span></a>
                                    </li>
                                    <li><a href="footer-4.html" title="Grid footer 2"><span>Grid footer 2</span></a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="mailbox-inbox-alt.html" title="Inbox"><span>Inbox</span></a></li>
                                    <li><a href="mailbox-compose.html"
                                           title="Compose message"><span>Compose message</span></a>
                                    </li>
                                    <li><a href="mailbox-message.html"
                                           title="View message"><span>View message</span></a>
                                    </li>
                                </ul>
                                <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="page-container.html"
                                           title="Page with container"><span>Page with container</span></a></li>
                                    <li><a href="page-single-wrapper.html" title="Page with single wrapper"><span>Page with single wrapper</span></a>
                                    </li>
                                    <li><a href="page-multiple-wrappers.html" title="Page with multiple wrappers"><span>Page with multiple wrappers</span></a>
                                    </li>
                                    <li><a href="page-scrollbar.html" title="Page with custom scrollbar"><span>Page with custom scrollbar</span></a>
                                    </li>
                                    <li><a href="page-tabs.html" title="Page with tabs navigation"><span>Page with tabs navigation</span></a>
                                    </li>

                                    <li class="header"><span>Navigation</span></li>
                                    <li><a href="navigation-menu-horizontal.html" title="Horizontal menu"><span>Horizontal menu</span></a>
                                    </li>
                                    <li><a href="navigation-menu-horizontal-centered.html"
                                           title="Centered horizontal menu"><span>Centered horizontal menu</span></a>
                                    </li>
                                    <li><a href="navigation-menu-collapsed.html"
                                           title="Collapsed horizontal menu"><span>Collapsed horizontal menu</span></a>
                                    </li>
                                    ...
                                    <li><a href="breadcrumb-sidebar-collapsed.html"
                                           title="Breadcrumb with collapsed menu"><span>Breadcrumb collapsed menu</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="divider"></li>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="index.html"
                                           title="Dashboard example 1"><span>Dashboard example 1</span></a></li>
                                    <li><a href="dashboard-2.html"
                                           title="Dashboard example 2"><span>Dashboard example 2</span></a></li>
                                    <li><a href="dashboard-3.html"
                                           title="Dashboard example 3"><span>Dashboard example 3</span></a></li>

                                    <li class="header"><span>Others</span></li>
                                    <li><a href="helper-classes.html" title="Helper classes"><span>Helper classes</span></a>
                                    </li>
                                    <li><a href="slidebars.html" title="Slidebars panels"><span>Slidebars panels</span></a>
                                    </li>
                                    ...
                                    <li><a href="lockscreen-page-1.html" target="_blank"
                                           title="Lockscreen example 1"><span>Lockscreen example 1</span></a>
                                    </li>
                                    <li><a href="lockscreen-page-2.html" target="_blank"
                                           title="Lockscreen example 2"><span>Lockscreen example 2</span></a>
                                    </li>
                                    <li><a href="lockscreen-page-3.html" target="_blank"
                                           title="Lockscreen example 3"><span>Lockscreen example 3</span></a>
                                    </li>

                                    <li class="header"><span>Login pages</span></li>
                                    <li><a href="login-page-1.html" target="_blank" title="Login example 1"><span>Login example 1</span></a>
                                    </li>
                                    <li><a href="login-page-2.html" target="_blank" title="Login example 2"><span>Login example 2</span></a>
                                    </li>
                                    <li><a href="login-page-3.html" target="_blank" title="Login example 3"><span>Login example 3</span></a>
                                    </li>
                                    <li><a href="login-page-4.html" target="_blank" title="Login example 4"><span>Login example 4</span></a>
                                    </li>
                                    <li><a href="login-page-5.html" target="_blank" title="Login example 5"><span>Login example 5</span></a>
                                    </li>

                                    <li class="header"><span>Server response</span></li>
                                    <li><a href="server-page-1.html" target="_blank"
                                           title="Server error example 1"><span>Server error example 1</span></a>
                                    </li>
                                    <li><a href="server-page-2.html" target="_blank"
                                           title="Server error example 2"><span>Server error example 2</span></a>
                                    </li>
                                    <li><a href="server-page-3.html" target="_blank"
                                           title="Server error example 3"><span>Server error example 3</span></a>
                                    </li>
                                    <li><a href="server-page-4.html" target="_blank"
                                           title="Server error example 4"><span>Server error example 4</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="divider"></li>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="bs-datepicker.html"
                                           title="Bootstrap datepicker"><span>Bootstrap datepicker</span></a></li>
                                    ...
                                    <li><a href="dynamic-tables.html" title="Dynamic tables"><span>Dynamic tables</span></a>
                                    </li>
                                    <li><a href="jgrowl-notifications.html" title="JGrowl notifications"><span>JGrowl notifications</span></a>
                                    </li>
                                    <li><a href="jqueryui-datepicker.html" title="jQueryUI datepicker"><span>jQueryUI datepicker</span></a>
                                    </li>
                                    <li><a href="lazyload.html"
                                           title="Images preloader"><span>Images preloader</span></a>
                                    </li>
                                    ...
                                    <li><a href="noty-notifications.html" title="Noty notifications"><span>Noty notifications</span></a>
                                    </li>
                                    ...
                                    <li><a href="progress-bars.html"
                                           title="Progress bars"><span>Progress bars</span></a>
                                    </li>
                                    <li><a href="sliders.html" title="Sliders"><span>Sliders</span></a></li>
                                    <li><a href="sortable.html" title="Sortable elements"><span>Sortable elements</span></a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="content-boxes.html"
                                           title="Content boxes"><span>Content boxes</span></a>
                                    </li>
                                    <li><a href="dashboard-boxes.html"
                                           title="Dashboard boxes"><span>Dashboard boxes</span></a>
                                    </li>
                                    ...
                                    <li><a href="social-boxes.html" title="Social boxes"><span>Social boxes</span></a>
                                    </li>
                                    <li><a href="spinners.html"
                                           title="Loading spinners"><span>Loading spinners</span></a>
                                    </li>
                            ...
                            <li>
                                <a href="#" title="Forms">
                                    ...
                                    <span>Forms</span>
                                    <span class="small-badge bg-primary"></span>
                                </a>
                                <ul>
                                    ...
                                    <li><a href="forms-elements.html" title="Forms elements"><span>Forms elements</span></a>
                                    </li>
                                    ...
                                    <li><a href="multi-upload.html"
                                           title="Multi uploader"><span>Multi uploader</span></a>
                                    </li>
                                    <li><a href="wizard.html" title="Wizard"><span>Wizard</span></a></li>
                                    <li><a href="wysiwyg-editor.html"
                            ...
                            <li>
                                <a href="#" title="Maps">
                                    ...
                                    <span>Maps</span>
                                    <span class="bs-label label-info">3</span>
                                </a>
                                <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="morris-charts.html"
                                           title="Morris charts"><span>Morris charts</span></a>
                                    </li>
                                    <li><a href="pie-gages.html"
                                           title="PieGages charts"><span>PieGages charts</span></a>
                                    </li>
                                    <li><a href="sparklines.html"
                        ...
                        <ul class="files-box">
                            <li>
                                ...
                                <div class="files-buttons">
                                    <a href="#" class="btn btn-xs hover-info tooltip-button" data-placement="right"
                                       title="Download">
                                        <i class="glyph-icon icon-cloud-download"></i>
                                    </a>
                                    <a href="#" class="btn btn-xs hover-danger tooltip-button" data-placement="right"
                                       title="Delete">
